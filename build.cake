...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./dotnet-args.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./dotnet-args.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/DotNet.Args/DotNet.Args.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
