...
Task("restore")
    ...
    .Does(() =>
{
    DotNetCoreRestore("./dotnet-args.sln", new DotNetCoreRestoreSettings
    {
        LockedMode = true,
    });
});
...
Task("build")
    ...
    .Does(() =>
{
    DotNetCoreBuild("./dotnet-args.sln", new DotNetCoreBuildSettings
    {
        Configuration = "Debug",
        NoRestore = true,
        NoIncremental = false,
...
Task("pack")
    ...
    .Does(() =>
{
    var releaseNotes = $"https://github.com/augustoproiete/dotnet-args/releases/tag/v{buildVersion.Version}";

    DotNetCorePack("./src/DotNet.Args/DotNet.Args.csproj", new DotNetCorePackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
